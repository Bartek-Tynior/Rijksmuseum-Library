...
function Description({ artObject }) {
  const newDate = new Date(artObject.acquisition.date).toLocaleDateString(
    "en-us",
    {
      year: "numeric",
      month: "long",
  ...
  return (
    <div className="details">
      ...
      <div className="dating">
        ...
        <p className="dating_presentingDate">
      ...
      <div className="aqusition">
        ...
        {artObject.acquisition.creditLine && (
          <h3 className="aqusition_credits">
            <span className="label_detail">Ontvangst: </span>{" "}
            {upperCase(artObject.acquisition.creditLine)}
          </h3>
        )}
        {artObject.acquisition.method && (
          <h3 className="aqusition_method">
            <span className="label_detail">Methode: </span>{" "}
            {upperCase(artObject.acquisition.method)}
          </h3>
        )}
        {artObject.acquisition.date && (
          <h3 className="aqusition_date">
            <span className="label_detail">Datum: </span> {newDate}
          </h3>
        )}
      </div>
